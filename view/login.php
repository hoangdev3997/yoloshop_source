        ...
        <div id="login-v2" class="row no-gutters">
            ...
            <div class="form-wrapper col-12 col-md-auto d-flex justify-content-center p-4 p-md-0">
                ...
                <div class="form-content md-elevation-8 h-100 bg-white text-auto py-16 py-md-32 px-12">
                    ...
                    <form name="loginForm" method="post" enctype="multipart/form-data" onsubmit="return validateForm()" class="mt-8">
                        ...
                        <button type="submit" name="submit_login" class="submit-button btn btn-block btn-secondary my-4 mx-auto" aria-label="LOG IN">
                            LOG IN
                        </button>
...
<div class="form-hidden hidden" id="error-form-hidden">
    <div class="form-del">
        <div class="col">
            <h3>Error Login</h3>
            <h4 id="output_error"></h4>
        </div>
        <div class="col">
            <div class="form-group row btn-wrapper">
                <input value="Cancel" type="button" class="btn btn-outline-danger btn_cancel">
            </div>
        </div>
    </div>
</div>
